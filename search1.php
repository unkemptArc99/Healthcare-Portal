...
<body style="z-index:1">
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <div style="position:absolute ;z-index:10; ">
        <div id="histin" style="display: block ; position:absolute">
             <table class="mdl-data-table mdl-js-data-table" style="position:absolute; z-index:11;margin: 80px 650px; ">
        <thead>
        <tr >
  ...
  if($q != "") {
    ...
    echo'  <div style="position:absolute">
        ...
        <button style="margin:200px 250px" class="mdl-button mdl-js-button mdl-button--raised mdl-button mdl-color--green">
          Generate_Price
        </button>
</form>
      </div>';
