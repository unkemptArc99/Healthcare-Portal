  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content" >
      ...
      <span style="position:absolute; margin:130px 50px" class="demo-card-square mdl-card mdl-shadow--2dp">
        ...
        <div class="mdl-card__supporting-text">New Appointment generation portal</div>
        <div  align="center" style="background-color:mdl-color--blue"  class="mdl-card__actions mdl-card--border">
          <a href="newappt1.php" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">New Appointment</a>
        </div>
      </span>
      <span style="position:absolute; margin:130px 410px" class="demo-card-square2 mdl-card mdl-shadow--2dp">
        ...
        <div style="" class="mdl-card__supporting-text">Search The Patient History</div>
        <div  align="center" style="background-color:mdl-color--blue"  class="mdl-card__actions mdl-card--border">
          <a href="pathis.php" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">Patient History</a>
        </div>
      </span>
    ...
    <style>
      ...
      .demo-card-square > .mdl-card__title {
        color: #fff;
        background: url('newappt.jpg') no-repeat #46B6AC ; size: 0px;
        background-size: 140%;
        opacity: 0.8;
      }
      .demo-card-square2 > .mdl-card__title {
        color: #fff;
        background: url('pres.jpg') no-repeat #46B6AC ; 
        background-size: 140%;
        opacity: 0.8;
      }
    </style>
