...
if(isset($_POST['srch']))
{
  ...
  if($q != "") 
  {
    ...
    {
      $username = $row['PatientUsrName'] ;
      $docusername = $row['StaffUsrName'];
      print_r($_COOKIE);
    ...
    <center><h5 style="color:; font-style:italic;margin-left:px"><b>New Prescription</b></h5></center>
    ...
    <input style="font-style:italic; color:green" class="mdl-textfield__input" type="text" id="aid" name="aid" value="'.$q.'" disabled />
    </span>
    <li style=""><b><span>Doctor User Name:</span></b>
    <span style="width:120px" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="font-style:italic">
    <input style="font-style:italic; color:green" class="mdl-textfield__input" type="text" id="docusername" name="docusername" value="'.$docusername.'" disabled />
    </span>
    </li>
    <li style=""><b><span>Patient User Name:</span></b>
    <span style="width:120px" class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="font-style:italic">
    <input style="font-style:italic; color:green" class="mdl-textfield__input" type="text" id="username" name="username" value="'.$username.'" disabled />
    </span>
    </li>
    <li>
    ...
    if(isset($_POST['generate']))
      {
        ...
        if(isset($_COOKIE[$cookiename]))
        {
          ...
          echo $aid."<br>".$user;
            ...
            echo "<font color=red>AppointmentID generated ".$row['AppointmentID']."</font><br>";
            echo '';
          echo "<meta http-equiv=\"refresh\" content=\"5;URL=newappt.php\" />";
        }
