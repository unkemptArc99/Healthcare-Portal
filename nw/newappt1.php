    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header" >
      ...
      <div class="android-header mdl-layout__header mdl-layout__header--waterfall">
        <div id ="bod" class="mdl-layout__header-row" style="background-color:black;height:80px;visibility:visible">
          ...
          <div class="mdl-navigation__link mdl-typography--" style="font-size:20px;float:right;background-color:green;margin-left:260px">
            <?php
          $conn=mysqli_connect("localhost","root","pulz@sql","FinalProject");
          if(!$conn)
      ...
      <div style="z-index:10;position:relative">
       ...
       <div style="position:absolute;margin:50px 920px; height:100px">
        <center>
        <b><h6 style=" font-style:italic;margin:10px 80px">Patient id</h5></b>
        <form action="newappt2.php" style="margin-top:10px; padding:20px" method="POST">
       ...
       <div id="dispin" style="position:absolute;margin:50px 300px; display:none">
        ...
        <form>
          <li style="color:green"><b>Name: </b></li><br>
          <li style="color:green"><b>Roll no:</b></li>
          <li>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="font-style:italic">
            <input class="mdl-textfield__input" type="text" id="username" style="font-style:italic" />
          ...
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="font-style:italic">
            <input class="mdl-textfield__input" type="text" id="username" style="font-style:italic"  />
            <label class="mdl-textfield__label" for="username" style=" color:green;font-size:14px" ><b>Medicine:</b></label>
          </div>
          </li>
           <li>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="font-style:italic">
            <input class="mdl-textfield__input" type="text" id="username" style="font-style:italic "" />
            <label class="mdl-textfield__label" for="username" style=" color:green;font-size:14px" ><b>Dosage</b></label>
          </div>
          </li>
           <li>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="font-style:italic">
            <input class="mdl-textfield__input" type="text" id="username"  style="font-style:italic" />
            <label class="mdl-textfield__label" for="username" style=" color:green;font-size:14px" ><b>Comments:</b></label>
          </div>
          </li>
