...
<body style="z-index:1">
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <div style="position:absolute ;z-index:10; ">
        ...
        <div style="border-radius: 90px; position:absolute;height:200px; width:500px; background-color:green; margin:20px 150px">
          <!-- Colored FAB button with ripple -->
<form action="" method="POST"> 
<div style="position:absolute; margin-left:12% ; width:80%; font-size:180px">
...
<button id="del" name="del" class="mdl-button mdl-js-button  mdl-button--raised mdl-js-ripple-effect mdl-button--colored">
  ...
  $sql="insert into Medicine values('$q','$q1',$q3)";
 ...
 if(isset($_POST['del'])) {
  ...
  $sq = "UPDATE Medicine SET MedicineName='$q1',Quantity ='$q2'  WHERE MedicineID='$q'";
