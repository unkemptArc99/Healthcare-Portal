...
<body style="z-index:1">
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <div style="z-index:10;position:relative">
       ...
       <div style="position:absolute;margin:50px 920px">
        ...
        <form >
          <input id ="pat" type="text" name="search" placeholder="Search.." style="font-style:italic">
  ...
  <thead>
    <tr >
      ...
      <th class="mdl-data-table__cell--non-numeric">Prescription</th>
      </tr>
  </thead>
  <tbody>
    <tr>
      <td class="mdl-data-table__cell--non-numeric">John Lennon</td>
      <td class="mdl-data-table__cell--non-numeric">The smart one   ksjdfas</td>
